    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <a href="{{url('admin/master/project/add')}}" class="btn btn-primary btn-sm">Add</a>
            </div>
            @endcan
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#datatable').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('/admin/master/project/list') }}",
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row){
                            let html = '';
                            @can('project.edit')
                            html = `<a href="{{url('/')}}/admin/master/project/edit/${data}"><i class="bx bx-edit"></i></a>`;
                            @endcan
                            return html;
                        },
                    }
