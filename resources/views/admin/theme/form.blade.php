    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="example-color-input" class="col-md-2 col-form-label">Date</label>
                    <div class="col-md-10">
                  <input type="text" class="form-control" id="datepicker-basic">
                    </div>
                </div>
                {{-- <div class="mb-0 row">
                    <label class="form-label col-lg-2 col-md-2">DateTime</label>
                    <input type="text" class="form-control col-lg-10 col-md-10" id="datepicker-basic">
                </div> --}}
